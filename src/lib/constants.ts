...
export const PLANS: Plan[] = [
  {
    ...
    label_id: "Free",
    creditsPerMonth: 10,
    tagline: "Coba 10 video gratis",
    features: [
      "10 kredit generate per bulan",
      "Kualitas 720p",
    ...
    highlighted: false,
    matrix: {
      audio: { quality: "Standar", voices: "1 suara", speed: false, emotion: false },
      script: { generate: true, scenes: "Maks 3 scene", categories: "3 kategori", hooks: "1 pilihan", regen: "2x per project" },
      subtitle: { auto: true, styles: "1 style", position: "Fixed bawah", exportSrt: false },
      video: { quality: "720p", footage: "Random otomatis", templates: "1 template", ratio: "9:16 saja" },
      trending: { ideas: "—", filter: false, alert: false },
      other: { history: "7 hari" },
    },
  },
  {
    id: "starter",
    ...
    label_id: "Starter",
    creditsPerMonth: 30,
    tagline: "1 video tiap hari kerja",
    features: [
      "30 kredit generate per bulan",
      "Kualitas 1080p",
      "Tanpa watermark",
      "Semua template",
      "Video permanen",
    ...
    watermark: false,
    template: "Semua",
    videoExpiry: "Permanen",
    srt: false,
    support: "Email",
    cta: "Mulai Sekarang",
    highlighted: true,
    matrix: {
      audio: { quality: "Natural AI Voice", voices: "10+ suara", speed: true, emotion: false },
      script: { generate: true, scenes: "Maks 5 scene", categories: "Semua kategori", hooks: "3 pilihan", regen: "5x per project" },
      subtitle: { auto: true, styles: "5 style", position: "Bisa diatur", exportSrt: false },
      video: { quality: "1080p", footage: "Pilih sendiri", templates: "5 template", ratio: "9:16 & 1:1" },
      trending: { ideas: "Lihat trending", filter: true, alert: false },
      other: { history: "30 hari" },
    },
  },
  {
    id: "pro",
    ...
    label_id: "Pro",
    creditsPerMonth: 100,
    tagline: "3+ video per hari",
    features: [
      "100 kredit generate per bulan",
      "Kualitas 1080p",
      "Tanpa watermark",
    ...
    highlighted: false,
    matrix: {
      audio: { quality: "Natural AI Voice", voices: "20+ suara", speed: true, emotion: true },
      script: { generate: true, scenes: "Maks 8 scene", categories: "Semua kategori", hooks: "Semua pilihan", regen: "Unlimited" },
      subtitle: { auto: true, styles: "Semua style", position: "Bisa diatur", exportSrt: true },
      video: { quality: "1080p", footage: "Pilih sendiri", templates: "Semua template", ratio: "Semua rasio" },
      trending: { ideas: "Lihat + filter niche", filter: true, alert: true },
      other: { history: "Unlimited" },
    },
  },
];